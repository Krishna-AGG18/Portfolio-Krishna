...
const Particles = ({
  ...
  useEffect(() => {
    ...
    const update = t => {
      ...
      if (moveParticlesOnHover) {
        particles.position.set(-mouseRef.current.x * particleHoverFactor, -mouseRef.current.y * particleHoverFactor, 0);
      } else {
  ...
  return <div ref={containerRef} className={`fixed top-0 bottom-0 w-full min-h-screen ${className}`} />;
};
