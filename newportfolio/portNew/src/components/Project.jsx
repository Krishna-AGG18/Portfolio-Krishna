...
const fullstackProjects = [
    {
        title: 'ThoughtHaven',
        description: 'A blog app with auth, CRUD, rich text editor, and responsive UI.',
    ...
    {
        title: 'ASKIO',
        description: 'An AI chatbot using Gemini API for chat, writing, coding help, and translation.',
    ...
    {
        title: 'Kuch Toh Naam',
        description: 'E-commerce frontend with cart, filters, search, loaders, and checkout.',
    ...
    {
        title: 'Note Nostre',
        description: 'Full-stack notes app with Firebase, featuring auth and real-time sync.',
...
const reactPracticeProjects = [
    ...
    },
    {
        ...
        description: 'A fun dice game built to practice state and rendering in React.',
    ...
    },
    {
        ...
        description: 'A to-do app using Redux Toolkit with create, update, and delete.',
    ...
    },
    {
        ...
        description: 'Currency converter with real-time rates, swap, and custom hooks.',
    ...
    {
        title: 'ScribeSpace',
        description: 'A simple notes app to create, edit, and delete with clean UI.',
...
function Project() {
    return (
        <div className="max-w-7xl h-full px-4 md:px-8 py-8 pt-20 mx-auto overflow-x-hidden">
            <h1 className="border-b border-b-gray-500 text-lg xs:text-4xl font-bold max-sm:text-center mb-4">✨Projects I have worked on...</h1>
